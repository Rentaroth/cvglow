...
const put = {
  tags: ['Aditionals'],
  summary: 'Edits aditional tools information of user in database',
  description: 'Create aditional tools information by suppliying an id.',
  security: [
    {
      BearerAuth: {
        schema: {
  ...
  requestBody: {
    description: 'Body schema for aditional tools modification',
    content: {
